...
exports.bookinstance_detail = function(req, res, next) {
    BookInstance.findById(req.params.id)
        ...
        .exec((err, bookinstance) => {
            ...
            res.render('bookinstance_detail', {title: 'Copy ' + bookinstance.title, bookInstance: bookinstance});
        })
};
...
exports.bookinstance_delete_get = function(req, res, next) {
    BookInstance.findById(req.params.id)
        ...
        .exec((err, book_instance) => {
            ...
            //successful, so render
            res.render('bookinstance_delete', {title: 'Copy ' + book_instance.title, book_instance: book_instance});
        })
};
...
exports.bookinstance_update_get = function(req, res, next) {
    BookInstance.findById(req.params.id)
        ...
        .exec((err, bookinstance) => {
            ...
            //successful, so render
            res.render('bookinstance_form', {title: 'Update book copy', bookInstance: bookinstance});
        })
};
